...
# Initially checks for enemies being around and being an attacking unit. 
...
# After it reaches the retreat point, it will bit able to 
# switch goals up to 10 tiles away, then the priority goes back to full
